...
class FlutterController extends Controller
{
    public function store(Request $request) {
        ...
        // SET CURL
        $curl = curl_init();
        $gateway_data = PaymentGateway::where('keyword','flutterwave')->first();
        ...
        $PBFPubKey = $gateway['public_key']; // get your public key from the dashboard.
