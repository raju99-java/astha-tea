...
class SliderController extends Controller
{
    ...
    {
         $user = Auth::user();
         $datas =   Slider::where('user_id',$user->id)->orderBy('id','desc')->get();
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Slider $data) {
                                return '<div class="action-list"><a href="' . route('vendor-slider-edit',$data->id) . '"> <i class="fas fa-edit"></i>Edit</a><a href="javascript:;" data-href="' . route('vendor-slider-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
