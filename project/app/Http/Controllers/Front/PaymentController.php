...
class PaymentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $gateway_data = PaymentGateway::where('keyword','paypal')->first();
        $gateway = $gateway_data->convertAutoData();


        
        $paypal_conf = \Config::get('paypal');
        $paypal_conf['client_id'] = $gateway['client_id'];
        $paypal_conf['secret'] = $gateway['client_secret'];
        $paypal_conf['settings']['mode'] = $gateway['sandbox_check'] == 1 ? 'sandbox' : 'live';
    ...
    public function paycancle(){
     ...
     public function customteapaycancle(){
         return redirect()->route('front.customteacheckout')->with('unsuccess','Payment Cancelled.');
     }
     ...
     public function payreturn(){
        ...
        $order = Order::findOrFail(Session::get('temporder_id'));
        }
     ...
     public function customteapayreturn(){

       
        $order = CustomTeaOrder::findOrFail(Session::get('temporder_id'));
        

        return view('front.customtea_success',compact('order'));
     }
