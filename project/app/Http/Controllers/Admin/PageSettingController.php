...
class PageSettingController extends Controller
{
    ...
    [
        ...
        'slider_right_banner1'    => 'mimes:jpeg,jpg,png,svg',
        'slider_right_banner2'    => 'mimes:jpeg,jpg,png,svg'
    ];
    ...
    [
        ...
        'slider_right_banner1.mimes'    => 'Photo type must be in jpeg, jpg, png, svg.',
        'slider_right_banner1.mimes'    => 'Photo type must be in jpeg, jpg, png, svg.'
    ...
    public function update(Request $request)
    {
        ...
        $input = $request->all();
            ...
            if ($file = $request->file('slider_right_banner1')) 
            {              
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->slider_right_banner1);
                $input['slider_right_banner1'] = $name;
            }    
            if ($file = $request->file('slider_right_banner2')) 
            {              
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->slider_right_banner2);           
                $input['slider_right_banner2'] = $name;
            } 

            if ($file = $request->file('gallery_large_banner')) 
            {              
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->gallery_large_banner);           
                $input['gallery_large_banner'] = $name;
            } 

            if ($file = $request->file('gallery_small_banner1')) 
            {              
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->gallery_small_banner1);           
                $input['gallery_small_banner1'] = $name;
            } 

            if ($file = $request->file('gallery_small_banner2')) 
            {              
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->gallery_small_banner2);           
                $input['gallery_small_banner2'] = $name;
            } 

            if ($file = $request->file('gallery_small_banner3')) 
            {              
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->gallery_small_banner3);           
                $input['gallery_small_banner3'] = $name;
            } 

            if ($file = $request->file('gallery_small_banner4')) 
            {              
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->gallery_small_banner4);           
                $input['gallery_small_banner4'] = $name;
            } 
    ...
    public function slider_right()
    {
        $data = Pagesetting::find(1);   
        return view('admin.pagesetting.slider_right',compact('data'));
    }

    public function gallary_large()
    {
        $data = Pagesetting::find(1);   
        return view('admin.pagesetting.gallary_large',compact('data'));
    }

    public function gallary_small()
    {
        $data = Pagesetting::find(1);   
        return view('admin.pagesetting.gallary_small',compact('data'));
    }
