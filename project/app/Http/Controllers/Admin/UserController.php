...
class UserController extends Controller
{
    public function __construct()
        ...
        {
            return view('admin.user.commercial_user');
        }
  		public function domestic_user()
        {
            return view('admin.user.domestic_user');
        }
        ...
        {  
            return view('admin.generalsetting.customer_cashback');
        }
...
// OTHER SECTION ENDS
        ...
        public function reject($id)
        {
         ...
         public function reward($id)
         {
             $sign = Currency::where('is_default','=',1)->first();
             $data = User::findOrFail($id);
             return view('admin.user.reward',compact('data','sign'));
         }
