...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $otp=$this->check_otp_balance();
        $activation_notify = "";


        return view('admin.dashboard',compact('pending','activation_notify','processing','completed','products','users','blogs','days','sales','pproducts','rorders','poproducts','rusers','referrals','browsers','otp'));
    }
    function check_otp_balance() {
        
      // Account details
      $username = 'asthatea';
      $apiKey = '2FA62-60C76';
      $apiRequest = 'CreditCheck';
      // Message details
      $sender = 'TASTHA';
      // Route details
      $apiRoute = 'OTP';
      ...
      $data = 'username='.$username.'&apikey='.$apiKey.'&apirequest='.$apiRequest.'&route='.$apiRoute.'&format='.$format;
