...
class Product extends Model
{
    ...
    public function showPreviousPrice() {
        ...
        if($this->category->commission != 0){
            $price = $this->previous_price + $this->previous_price * $this->category->commission / 100 ;
        }else{
    ...
    public function showName() {
        $name = mb_strlen($this->name,'utf-8') > 24 ? mb_substr($this->name,0,24,'utf-8').'...' : $this->name;
        return $name;
    }
    public function showDescription() {
        $name = mb_strlen($this->details,'utf-8') > 35 ? mb_substr($this->name,0,35,'utf-8').'...' : $this->name;
        return $name;
    }
    ...
    public function cross_selling_products() {
        return $this->hasMany('App\Models\CrossSellingProduct');
    }
