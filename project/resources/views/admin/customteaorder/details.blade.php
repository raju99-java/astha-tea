                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th width="45%">{{ __('Smell Product') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->smell->name}}( {{ $order->p1_weight }} gm)</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Colour Product') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->colour->name}}( {{ $order->p2_weight }} gm)</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ round(($order->total_price + $order->shipping_cost)  * $order->currency_value , 2) }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td width="45%">{{ __('Order Status') }}</th>
                                                    <td width="10%">:</th>
                                                    <td width="45%"><span class='badge badge-success'>{{$order->status}}</span></td>
                                                </tr>
                                        ...
                                        <div class="footer-area">
                                            <a href="{{ route('admin-customtea-order-invoice',$order->id) }}" class="mybtn1"><i class="fas fa-eye"></i> {{ __('View Invoice') }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                                    ...
                                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th width="20%">{{ __('Total Weight') }}</th>
