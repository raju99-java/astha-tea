                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-role-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 d-flex justify-content-between">
                              <label class="control-label">{{ __('Custom Tea Order') }} *</label>
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="custom_tea_order" {{ $data->sectionCheck('custom_tea_order') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <!--<div class="col-lg-4 d-flex justify-content-between">-->
                          <!--  <label class="control-label">{{ __('Manage Commission') }} *</label>-->
                          <!--  <label class="switch">-->
                          <!--    <input type="checkbox" name="section[]" value="commission" {{ $data->sectionCheck('commission') ? 'checked' : '' }} >-->
                          <!--    <span class="slider round"></span>-->
                          <!--  </label>-->
                          <!--</div>-->
                          <div class="col-lg-4 d-flex justify-content-between">
                          ...
                          <div class="col-lg-2"></div>
                          <div class="col-lg-4 d-flex justify-content-between">
                            <label class="control-label">{{ __('Total Earning') }} *</label>
                            <label class="switch">
