...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __('Delivery Partner') }} 
				</h4>
				<ul class="links">
					<li>
					...
					<li>
						<a href="{{ route('admin-deliveryboys-create') }}">{{ __('Add Delivery Partner') }}</a>
					</li>
	...
	<form id="geniusform" action="{{route('admin-deliveryboys-store')}}" method="POST" enctype="multipart/form-data">
		{{csrf_field()}}	
	<div class="row">
		<div class="col-lg-10">
							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="row">
										<div class="col-lg-4">
										<div class="left-area">
											<h4 class="heading">{{ __("Delivery Partner Profile Image") }} *</h4>
										</div>
										</div>
										<div class="col-lg-7">
