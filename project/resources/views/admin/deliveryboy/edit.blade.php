								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-deliveryboys-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <div class="img-upload">
						                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/images/deliveryboys/'.$data->photo):asset('assets/images/noimage.png') }});">
												...
												<div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <div class="img-upload">
						                                <div id="image-preview" class="img-preview" style="background: url({{ $data->govt_id_proof ? asset('assets/images/deliveryboys/'.$data->govt_id_proof):asset('assets/images/noimage.png') }});">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">{{ __('Vehicle number') }}*</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="vehicle_number" type="text" class="input-field"
															placeholder="{{ __('Enter Vehicle Number') }}" value="{{ $data->vehicle_number }}">
