...
@section('content')
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __("Delivery Partner Details") }} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
                                        <ul class="links">
                                            <li>
                                                <a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }} </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin-deliveryboys-index') }}">{{ __("Delivery Partner") }}</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin-deliveryboys-show',$data->id) }}">{{ __("Details") }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="user-image">
                                                            ...
                                                            <img src="{{ $data->photo ? asset('assets/images/deliveryboys/'.$data->photo):asset('assets/images/'.$gs->user_image)}}" alt="No Image">                                            
                                                    ...
                                                    <div class="table-responsive show-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <a class="mybtn1" href="{{asset('assets/images/deliveryboys/'.$data->govt_id_proof)}}" target="_blank">click here to view</a></td>
                                                        </tr>
                                                        <tr>
