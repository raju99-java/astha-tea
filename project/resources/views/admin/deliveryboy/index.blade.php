...
@section('content')  
					<input type="hidden" id="headerdata" value="{{ __("DELIVERY BOY") }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __("Delivery Partner") }}</h4>
										<ul class="links">
											<li>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-deliveryboys-datatables') }}',
               columns: [
                        { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="{{route('admin-deliveryboys-create')}}">'+
