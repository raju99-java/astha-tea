                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th width="45%">{{__('Tax')}} ({{$order->tax_location}})</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{$order->tax * $order->currency_value ,2}}</td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="row">
                                            ...
                                            <div class="table-responsiv">
                                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                        <thead>
                                                            <tr>
                                                            <tr>
                                                                <th width="10%">{{ __('Product SKU/ID#') }}</th>
                                                                <th>{{ __('Status') }}</th>
                                ...
                                @foreach($cart['items'] as $key => $product)
                                    <tr>
                                            ...
                                            <td><input type="hidden" value="{{$key}}">{{ isset($product['item']['sku'])?$product['item']['sku']:$product['item']['id'] }}</td>
