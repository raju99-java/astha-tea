								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-user-reward-update',$data->id) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												...
												<div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="left-area">
                                                                    <h4 class="heading">{{ __("Current Reward") }} *</h4>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-7">
                                                                <h6 class="heading">{{ $data->reward}} </h6>
                                                        </div>
                                                    </div>
