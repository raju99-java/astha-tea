								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{route('admin-prod-feature',$data->id)}}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("Highlight in Featured") }}  *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
									   ...
									   <!--               </div>-->
												...
												<!--	<div class="col-lg-8">-->
												<!--		<div class="left-area">-->
												<!--				<h4 class="heading">{{ __("Highlight in Top Rated ") }} *</h4>-->
												<!--		</div>-->
												<!--	</div>-->
									   <!--               <div class="col-sm-3">-->
									   <!--                 <label class="switch">-->
									   ...
									   <!--               </div>-->
												...
												<!--	<div class="col-lg-8">-->
												<!--		<div class="left-area">-->
												<!--				<h4 class="heading">{{ __("Highlight in Big Save") }} *</h4>-->
												<!--		</div>-->
												<!--	</div>-->
									   <!--               <div class="col-sm-3">-->
									   <!--                 <label class="switch">-->
									   ...
									   <!--               </div>-->
												...
												<!--	<div class="col-lg-8">-->
												<!--		<div class="left-area">-->
												<!--				<h4 class="heading">{{ __("Highlight in Hot ") }} *</h4>-->
												<!--		</div>-->
												<!--	</div>-->
									   <!--               <div class="col-sm-3">-->
									   <!--                 <label class="switch">-->
									   ...
									   <!--               </div>-->
												...
												<!--	<div class="col-lg-8">-->
												<!--		<div class="left-area">-->
												<!--				<h4 class="heading">{{ __("Highlight in New") }} *</h4>-->
												<!--		</div>-->
												<!--	</div>-->
									   <!--               <div class="col-sm-3">-->
									   <!--                 <label class="switch">-->
									   ...
									   <!--               </div>-->
												...
												<!--	<div class="col-lg-8">-->
												<!--		<div class="left-area">-->
												<!--				<h4 class="heading">{{ __("Highlight in Trending") }}*</h4>-->
												<!--		</div>-->
												<!--	</div>-->
									   <!--               <div class="col-sm-3">-->
									   <!--                 <label class="switch">-->
									   ...
									   <!--               </div>-->
												...
												<!--	<div class="col-lg-8">-->
												<!--		<div class="left-area">-->
												<!--				<h4 class="heading">{{ __("Highlight in Sale") }} *</h4>-->
												<!--		</div>-->
												<!--	</div>-->
									   <!--               <div class="col-sm-3">-->
									   <!--                 <label class="switch">-->
									   ...
									   <!--               </div>-->
												...
												<!--	<div class="col-lg-8">-->
												<!--		<div class="left-area">-->
												<!--				<h4 class="heading">{{ __("Highlight in Flash Deal") }} *</h4>-->
												<!--		</div>-->
												<!--	</div>-->
									   <!--               <div class="col-sm-3">-->
									   <!--                 <label class="switch">-->
