                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th width="45%">{{ __('Tax') }} (<b>{{$order->tax_location}}</b>)</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{$order->tax}}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">:</th>
                                                    <td width="45%">{!! $order->payment_status == 'Pending' ? "<span class='badge badge-danger'>". __('Unpaid') ."</span>":"<span class='badge badge-success'>". __('Paid') ."</span>" !!}</td>
                                                </tr>
                            ...
                            <div class="row">
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" class="btn btn-info product-btn" id="license" style="padding: 5px 12px;"><i class="fa fa-eye"></i> View License</a>
                                            ...
                                            <td>
                                               ...
                                               <p>
                                                    <strong>{{ __('Quantity') }} :</strong> {{$product['qty']}} {{ $product['item']['measure'] }}
                                               </p>
        ...
        <h4 class="modal-title d-inline-block">{{__('License Key') }}</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <p class="text-center">{{ __('The Licenes Key is') }} :  <span id="key"></span> <a href="javascript:;" id="license-edit">{{ __('License Key') }}</a><a href="javascript:;" id="license-cancel" class="showbox">{{ __('Cancel') }}</a></p>
                    ...
                    <input type="text" name="{{ __('Save License') }}" placeholder="{{ __('Enter New License Key') }}" style="width: 40%; border: none;" required=""><input type="submit" name="submit" value="Save License" class="btn btn-primary" style="border-radius: 0; padding: 2px; margin-bottom: 2px;">
                        </div>
                    </form>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="contact-form">
                                <form id="emailreply">
                                    ...
                                    <ul>
                                        <li>
                                            <input type="email" class="input-field eml-val" id="eml" name="to" placeholder="{{ __('Email Address') }} *" value="" required="">
                                        </li>
                                        <li>
