							  ...
							  <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
								  ...
								  @endforeach
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Product Platform') }}" name="platform" value="{{ $data->platform }}">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Product Region') }}" name="region" value="{{ $data->region }}">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('License Type') }}e" name="licence_type" value="{{ $data->licence_type }}">
										</div>
									</div>
