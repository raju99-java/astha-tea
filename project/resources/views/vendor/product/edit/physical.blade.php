...
@section('content')
	...
	<div class="content-area">
		<div class="mr-breadcrumb">
			<div class="row">
				<div class="col-lg-12">
						<h4 class="heading"> {{ __('Edit Product') }} <a class="add-btn" href="{{ route('vendor-prod-index') }}"><i class="fas fa-arrow-left"></i> {{__('Back') }}</a></h4>
						<ul class="links">
							<li>
							  ...
							  <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
								...
								@include('includes.vendor.form-both')
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Product Name') }}" name="name" required="" value="{{ $data->name }}">
										</div>
									</div>
								  ...
								  @endforeach
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Product Estimated Shipping Time') }}" name="ship" value="{{ $data->ship == null ? "" : $data->ship }}">
										</div>
									</div>
														 ...
														 @foreach($data->size as $key => $data1)
															...
															<div  class="row">
																	<div class="col-md-4 col-sm-6">
																		...
																		<input type="text" name="size[]" class="input-field" placeholder="{{ __('Size Name') }}" value="{{ $data->size[$key] }}">
																	</div>
																	<div class="col-md-4 col-sm-6">
																			<label>
																				{{ __('Size Qty') }} :
																		...
																		<input type="number" name="size_qty[]" class="input-field" placeholder="{{ __('Size Qty') }}" min="1" value="{{ $data->size_qty[$key] }}">
																	</div>
																	<div class="col-md-4 col-sm-6">
																			<label>
																				{{ __('Size Price') }} :
								...
								<div class="{{ $data->measure == null ? 'showbox' : '' }}">
									...
									<div class="row">
										...
										<div class="col-lg-3 {{ in_array($data->measure,explode(',', 'Gram,Kilogram,Litre,Pound')) ? 'hidden' : '' }}" id="measure">
											<input name="measure" type="text" id="measurement" class="input-field" placeholder="{{ __('Enter Unit') }}" value="{{$data->measure}}">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="text-editor">
												<textarea name="specification" class="nic-edit-p">{{$data->specification}}</textarea>
											</div>
										</div>
									</div>
											...
											<div class="body-area">
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="left-area">
															<h4 class="heading">
																{{ __('Minimum Order Quantity') }}*
															</h4>

														</div>
													</div>
													<div class="col-lg-12">
														<input name="min_qty" min="1" type="number" class="input-field"
															placeholder="{{ __('Minimum Order Quantity') }}" required="" value="{{$data->min_qty}}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<input  name="youtube" type="text" class="input-field" placeholder="{{ __('Youtube Video URL') }}" value="{{$data->youtube}}">
													</div>
												</div>
