...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __('Physical Product') }} <a class="add-btn" href="{{ route('vendor-prod-types') }}"><i
								...
								<div class="gocover"
									...
									<div class="showbox">
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<input type="text" class="input-field" placeholder="{{ __('Product Estimated Shipping Time') }}"
													name="ship">
											</div>
										</div>
															...
															<div class="row">
																<div class="col-lg-6">
																	<input type="number" name="whole_sell_qty[]"
																		class="input-field" placeholder="{{ __('Enter Quantity') }}"
																		min="0">
																</div>

																<div class="col-lg-6">
																	<input type="number" name="whole_sell_discount[]"
																		class="input-field" placeholder="{{ __('Enter Discount Percentage') }}"
																		min="0" />
																</div>
															</div>
														</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="min_qty" min="1" type="number" class="input-field"
												placeholder="{{ __('Minimum Order Quantity') }}" required="" value="1">
										</div>
									</div>
