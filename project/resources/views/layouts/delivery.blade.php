...
<head>
		...
		<link href="{{asset('assets/delivery/css/common.css')}}" rel="stylesheet" />
								...
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notf_conv" class="dropdown-toggle-1"  href="#" style="border: 1px solid;border-radius: 20px;">
											<i class="icofont-wallet"></i><i class="icofont-inr" aria-hidden="true"></i>{{number_format(Auth::guard('delivery')->user()->commission,2)}}
										</a>
									</li>
									...
									<li class="login-profile-area">
										<a class="dropdown-toggle-1" href="javascript:;">
											<div class="user-img">
												<img src="{{ Auth::guard('delivery')->user()->photo ? asset('assets/images/deliveryboys/'.Auth::guard('delivery')->user()->photo ):asset('assets/images/1567655174profile.jpg') }}" alt="">
											</div>
										</a>
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper">
												<ul>
													<h5>{{ __('Welcome!') }}</h5>
													<!-- <li>
														<a href="{{ route('delivery.profile') }}"><i class="fas fa-user"></i> {{ __('Edit Profile') }}</a>
													</li> -->
													<li>
														<a href="{{ route('delivery.logout') }}"><i class="fas fa-power-off"></i> {{ __('Logout') }}</a>
													</li>
												</ul>
											</div>
										</div>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							<li>
								<a href="{{ route('delivery.dashboard') }}" class="wave-effect"><i class="fa fa-home mr-2"></i>{{ __('Dashboard') }}</a>
							</li>
							
							@include('includes.delivery.roles.super')
    ...
    <script src="{{asset('assets/delivery/js/vendors/vue.js')}}"></script>
		...
		<script src="{{asset('assets/delivery/js/Chart.min.js')}}"></script>
        ...
        <script src="{{asset('assets/delivery/js/notify.js') }}"></script>
        <script src="{{asset('assets/delivery/js/jquery.canvasjs.min.js')}}"></script>
