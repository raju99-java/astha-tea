				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a href="{{ route('vendor-dashboard') }}" class="wave-effect "><i class="fa fa-home mr-2"></i>{{__('Dashbord') }}</a>
							</li>
							<li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="general" data-parent="#accordion">
									<li>
										<a href="{{ route('vendor-slider-index') }}"><span>{{ __('Sliders') }}</span></a>
									</li>
	                                ...
	                                @endif
                                    <li>
                                    	<a href="{{ route('vendor-social-index') }}"><span>{{ __('Social Links') }}</span></a>
                                    </li>
								</ul>
							</li>
							<li>
