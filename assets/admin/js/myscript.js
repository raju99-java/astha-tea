...
$(document).on('submit','#salestotalsoldformdata',function(e){
  e.preventDefault();
if(admin_loader == 1)
  {
  $('.submit-loader').show();
        ...
        if(admin_loader == 1)
          {
            ...
            $('#salestotalsoldformdata input , #salestotalsoldformdata select , #salestotalsoldformdata textarea').eq(1).focus();
          }
          else
          {
            $('#show_total_order').removeClass('d-none');
            ...
            $('#total_sales').html(data.total_sales);
            $('#total_sold').html(data.total_sold);
            $('#total_sales_customtea').html(data.total_sales_customtea);
            $('#total_sold_customtea').html(data.total_sold_customtea);
        if(admin_loader == 1)
          {
            $('.submit-loader').hide();
          }
